...
accelerate launch train.py \
 ...
 --output_dir="output/sd-same-level-latent-control-lora-face-landmarks" \
 ...
 --use_same_level_conditioning_latent \
 --learning_rate=1e-4 \
 ...
 --tracker_project_name="same-level-latent-control-lora" \
