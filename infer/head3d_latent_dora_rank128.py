...
from train.head3d_latent_dora_rank128 import config
from custom_datasets.head3d import Head3dDataset
...
# dataset = Head3dDataset(size=512)
# image = Image.fromarray(np.uint8(dataset[0]['hint'] * 255.0))
image = Image.open("./docs/imgs/head3d1.jpeg")
